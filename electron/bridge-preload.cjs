...
contextBridge.exposeInMainWorld('bridgeAPI', {
  ...
  getPrinterRoutes: () => ipcRenderer.invoke('bridge:getPrinterRoutes'),
  setPrinterRoutes: (routes) => ipcRenderer.invoke('bridge:setPrinterRoutes', { routes }),
  testPrinter: (route) => ipcRenderer.invoke('bridge:testPrinter', { route }),
